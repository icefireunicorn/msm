...
public class TopicMessageListener implements MessageListener {
	private static Logger logger = LoggerFactory
			.getLogger(TopicMessageListener.class);
	...
	public void onMessage(Message message) {
		...
		try {
			...
			System.out.println("topic收到消息" + noticeInfo.getNoticeContent());
			System.out.println("model:" + objectMessage.getJMSDeliveryMode());
			System.out.println("destination:"
					+ objectMessage.getJMSDestination());
			...
			System.out.println("expiredTime:"
					+ objectMessage.getJMSExpiration());
